        ...
        <div class="admin-section">
          <div class="balance">
            <table>
              ...
              <tbody>
                <template v-for="item in data" :key="item.id_User">
                  <tr>
                    <td>
          ...
          <div class="modal-content">
            ...
            <form @submit.prevent="submitUpdate">
              <div class="form-group">
                ...
                <input v-model="updateForm.userName" id="userName" type="text" required />
              </div>
              <div class="form-group">
                <label for="email">Email</label>
                <input v-model="updateForm.email" id="email" type="email" required />
              </div>
              <div class="form-group">
                <label for="password">Mot de passe (optionnel)</label>
                <input v-model="updateForm.password" id="password" type="password" />
              </div>
